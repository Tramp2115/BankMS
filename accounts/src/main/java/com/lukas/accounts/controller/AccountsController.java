package com.lukas.accounts.controller;
...
import com.lukas.accounts.dto.ErrorResponseDto;
import com.lukas.accounts.dto.ResponseDto;
...
@Tag(
        name="CRUD REST APIs for Accounts in LukasBank",
        description = "CRUD REST APIs in LukasBank to CREATE, UPDATE, FETCH AND DELETE account details"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Account inside LukasBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Get Java verions details that is installed into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
